...
export const polySymetricOfb = ({ typedWords, kind }) => (dispatch) => {
  let wordFound = false;
  if (typedWords.length === POLY_SYM_OF_B.length) {
    const convertedWords = compareWords(typedWords, POLY_SYM_OF_B);
...
export default polySymetricOfb;

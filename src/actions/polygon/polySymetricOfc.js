...
export const polySymetricOfc = ({ typedWords, kind }) => (dispatch) => {
  let wordFound = false;
  if (typedWords.length === POLY_SYM_OF_C.length) {
    const convertedWords = compareWords(typedWords, POLY_SYM_OF_C);
...
export default polySymetricOfc;
